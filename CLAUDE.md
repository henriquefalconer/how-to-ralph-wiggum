...
- **Always close the tab when the task is done.** Whenever you used claude-in-chrome, close the tabs you opened before ending your turn, and leave no Claude tab groups open in Chrome.
